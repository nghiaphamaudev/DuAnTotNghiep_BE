...
<body>
  ...
  <div class="container">
    ...
    <p>Chúng tôi muốn thông báo rằng yêu cầu hoàn tiền của bạn đã được xử lý thành công. Sau khi xác minh giao dịch, số tiền <span class="highlight">${refundAmount} VNĐ</span> sẽ được hoàn lại vào phương thức thanh toán của bạn trong khoảng 1 - 2 ngày.</p>
