...
export function templateConfirmOrder2(
  orderId,
  orderDate,
  totalPrice,
  products,
...
<html xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
 ...
 <link href="https://fonts.googleapis.com/css?family=Hanken+Grotesk:ital,wght@0,400;0,400;0,500;0,600;0,700" rel="stylesheet" />
    <style>
      html,
      body {
        margin: 0 !important;
    ...
    <style>
      @media (max-width: 620px) {
        ...
        .pc-w620-fontSize-17px {
          font-size: 17px !important;
        }
        .pc-w620-padding-12-20-12-20 {
          padding: 12px 20px 12px 20px !important;
        }
        .pc-w620-width-100pc {
          width: 100% !important;
        }
        .pc-w620-padding-30-28-30-28 {
        ...
        .pc-w620-padding-0-0-12-0 {
          padding: 0px 0px 12px 0px !important;
        }
        .pc-w620-valign-bottom {
        ...
        .pc-w620-padding-28-28-28-28 {
          padding: 28px 28px 28px 28px !important;
        }
        .pc-w620-itemsSpacings-0-15 {
          padding-left: 0px !important;
          padding-right: 0px !important;
          padding-top: 7.5px !important;
          padding-bottom: 7.5px !important;
        }
        .pc-w620-itemsSpacings-0-12 {
          padding-left: 0px !important;
          padding-right: 0px !important;
          padding-top: 6px !important;
          padding-bottom: 6px !important;
        }
        .pc-w620-itemsSpacings-0-28 {
          padding-left: 0px !important;
          padding-right: 0px !important;
    ...
    <style>
      @font-face {
        ...
        font-style: normal;
        font-weight: 400;
        src: url('https://fonts.gstatic.com/s/hankengrotesk/v8/ieVq2YZDLWuGJpnzaiwFXS9tYvBRzyFLlZg_f_Ncs2Zq6PBK.woff')
            format('woff'),
          url('https://fonts.gstatic.com/s/hankengrotesk/v8/ieVq2YZDLWuGJpnzaiwFXS9tYvBRzyFLlZg_f_Ncs2Zq6PBM.woff2')
            format('woff2');
      }
      @font-face {
        font-family: 'Hanken Grotesk';
        font-style: normal;
        font-weight: 700;
        src: url('https://fonts.gstatic.com/s/hankengrotesk/v8/ieVq2YZDLWuGJpnzaiwFXS9tYvBRzyFLlZg_f_NcVGFq6PBK.woff')
            format('woff'),
          url('https://fonts.gstatic.com/s/hankengrotesk/v8/ieVq2YZDLWuGJpnzaiwFXS9tYvBRzyFLlZg_f_NcVGFq6PBM.woff2')
            format('woff2');
      }
      @font-face {
        font-family: 'Hanken Grotesk';
        font-style: normal;
        font-weight: 500;
        src: url('https://fonts.gstatic.com/s/hankengrotesk/v8/ieVq2YZDLWuGJpnzaiwFXS9tYvBRzyFLlZg_f_NcgWZq6PBK.woff')
            format('woff'),
          url('https://fonts.gstatic.com/s/hankengrotesk/v8/ieVq2YZDLWuGJpnzaiwFXS9tYvBRzyFLlZg_f_NcgWZq6PBM.woff2')
            format('woff2');
      }
      @font-face {
        font-family: 'Hanken Grotesk';
        font-style: normal;
        font-weight: 600;
        src: url('https://fonts.gstatic.com/s/hankengrotesk/v8/ieVq2YZDLWuGJpnzaiwFXS9tYvBRzyFLlZg_f_NcbWFq6PBK.woff')
            format('woff'),
          url('https://fonts.gstatic.com/s/hankengrotesk/v8/ieVq2YZDLWuGJpnzaiwFXS9tYvBRzyFLlZg_f_NcbWFq6PBM.woff2')
            format('woff2');
      }
    </style>
  </head>
  ...
  >
    <table
      ...
      style="table-layout: fixed; min-width: 600px; background-color: #f3e5ff"
      bgcolor="#f3e5ff"
      width="100%"
      border="0"
      cellspacing="0"
                          ...
                          >
                            ...
                            >
                              <tr>
                                <td
                                  valign="top"
                                  class="pc-w620-padding-30-28-30-28"
                                  style="
                                ...
                                >
                                  ...
                                  >
                                    <tr>
                                      ...
                                      >
                                        <img
                                          src="https://res.cloudinary.com/dyv5zfnit/image/upload/v1732118685/email/z6052435918310_c217cd885894f1347e18fb69c792658e_uwe2ai.jpg"
                                  ...
                                  >
                                    <tr>
                                      <td
                                        class="pc-w620-spacing-0-0-12-0"
                                        align="center"
                                        valign="top"
                                      ...
                                      >
                                        ...
                                        >
                                          <tr>
                                            ...
                                            >
                                              <div
                                                class="pc-font-alt pc-w620-fontSize-15px pc-w620-lineHeight-140pc"
                                                style="
                                                  line-height: 160%;
                                              ...
                                              >
                                                <div>
                                                  <span
                                                    >Tin tuyệt vời! Đơn hàng của
                                                    bạn đã sẵn sàng lên đường.
                                                    Chúng tôi đang đóng gói cẩn
                                                    thận và sẽ nhanh chóng gửi
                                                    đến bạn.</span
                                                  >
                                                </div>
                                              </div>
                                  ...
                                  >
                                    <tr>
                                      <td style="padding: 0px 0px 41px 0px">
                                        <table
                                          class="pc-width-fill pc-w620-gridCollapsed-0 pc-w620-width-hug"
                                          width="100%"
                                          border="0"
                                          cellpadding="0"
                                          cellspacing="0"
                                        ...
                                        >
                                          ...
                                          >
                                            <td
                                              class="pc-grid-td-first pc-w620-itemsSpacings-8-12"
                                              align="center"
                                              valign="middle"
                                              style="
                                            ...
                                            >
                                              ...
                                              >
                                                <tr>
                                                  <td
                                                    class="pc-w620-padding-16-12-16-12"
                                                    align="center"
                                                    valign="middle"
                                                    style="
                                                      padding: 20px 20px 20px
                                                        20px;
                                                      background-color: #6a4476;
                                                        ...
                                                        >
                                                          ...
                                                          >
                                                            <tr>
                                                              ...
                                                              >
                                                                <img
                                                                  src="https://res.cloudinary.com/dyv5zfnit/image/upload/v1732099443/email/58d6e995af1dc9bb85777d48ef698ba4_idgexm.png"
                                                                  class="pc-w620-width-32 pc-w620-height-auto"
                                                                  width="60"
                                                                  height="59"
                                                                  alt=""
                                                                  style="
                                                              ...
                                                              >
                                                                ...
                                                                >
                                                                  <tr>
                                                                    ...
                                                                    >
                                                                      <div
                                                                        class="pc-font-alt pc-w620-fontSize-14px"
                                                                        style="
                                                                          line-height: 142%;
                                            ...
                                            <td
                                              class="pc-w620-itemsSpacings-8-12"
                                              align="center"
                                              valign="middle"
                                              style="
                                                width: 33.333333333333%;
                                                        ...
                                                        >
                                                          ...
                                                          >
                                                            <tr>
                                                              ...
                                                              >
                                                                <img
                                                                  src="https://res.cloudinary.com/dyv5zfnit/image/upload/v1732099443/email/ee7587a7a91d1d13a23e640307d512fe_h4gvn3.png"
                                                                  class="pc-w620-width-32 pc-w620-height-auto"
                                                                  width="60"
                                                                  height="60"
                                                                  alt=""
                                            ...
                                            <td
                                              class="pc-grid-td-last pc-w620-itemsSpacings-8-12"
                                              align="center"
                                              valign="middle"
                                              style="
                                                width: 33.333333333333%;
                                                        ...
                                                        >
                                                          ...
                                                          >
                                                            <tr>
                                                              ...
                                                              >
                                                                <img
                                                                  src="https://res.cloudinary.com/dyv5zfnit/image/upload/v1732099444/email/b0d03ad328483a5b0a93bf66b6be6745_yekujk.png"
                                                                  class="pc-w620-width-32 pc-w620-height-auto"
                                                                  width="60"
                                                                  height="60"
                                                                  alt=""
                                  ...
                                  >
                                    <tr>
                                      ...
                                      >
                                        ...
                                        <!--[if !mso]><!-- -->
                                        <a
                                          class="pc-w620-width-100pc pc-w620-fontSize-17px pc-w620-padding-12-20-12-20"
                                          style="
                                            display: inline-block;
                                            box-sizing: border-box;
                                            border-radius: 134px 134px 134px
                                              134px;
                                            background-color: #f5c04e;
                                            padding: 16px 32px 16px 32px;
                          ...
                          >
                            ...
                            >
                              <tr>
                                <td
                                  valign="top"
                                  class="pc-w620-padding-28-28-28-28"
                                  style="
                                      ...
                                      >
                                        ...
                                        >
                                          <tr>
                                            ...
                                            >
                                              <div
                                                class="pc-font-alt pc-w620-fontSize-30px pc-w620-lineHeight-140pc"
                                                style="
                                                  line-height: 128%;
                                                              ...
                                                              >
                                                                ...
                                                                >
                                                                  <tr>
                                                                    ...
                                                                    >
                                                                      <div
                                                                        class="pc-font-alt pc-w620-fontSize-15px"
                                                                        style="
                                                                          line-height: 121%;
                                                                          letter-spacing: -0.2px;
                                                                          font-family: 'Hanken Grotesk',
                                      ...
                                      <td style="padding: 0px 0px 16px 0px">
                                        ...
                                        ${products
                                          .map(
                                            (item) => `<tr>  
                                              <td
                                                class="pc-w620-padding-16-0-12-0"
                                                align="left"
                                                valign="top"
                                                style="
                                                                  ...
                                                                  >
                                                                    <tr>
                                                                      ...
                                                                      >
                                                                        <img
                                                                          src="${item.images}"
                                                                          class="pc-w620-width-150 pc-w620-height-100pc"
                                                                          width="100"
                                                                          height="100"
                                                                          alt=""
                                                                          style="
                                                                                  ...
                                                                                  >
                                                                                    ...
                                                                                    >
                                                                                      <tr>
                                                                                        ...
                                                                                        >
                                                                                          <div
                                                                                            class="pc-font-alt pc-w620-fontSize-16px pc-w620-lineHeight-140pc"
                                                                                            style="
                                                                                              line-height: 140%;
                                              ...
                                              <td
                                                class="pc-w620-halign-right pc-w620-valign-bottom pc-w620-padding-12-0-12-0"
                                                align="right"
                                                valign="bottom"
                                                style="
                                                  padding: 12px 0px 12px 0px;
                                                                ...
                                                                >
                                                                  ...
                                                                  >
                                                                    <tr>
                                                                      ...
                                                                      >
                                                                        <div
                                                                          class="pc-font-alt pc-w620-align-right pc-w620-fontSize-14px"
                                                                          style="
                                                                            line-height: 140%;
                                                                            letter-spacing: -0.2px;
                                                                            font-family: 'Hanken Grotesk',
                                          ...
                                          .join('')}
                                            ...
                                            <tr align="right" valign="middle">
                                              <td
                                                class="pc-w620-halign-left pc-w620-valign-middle pc-w620-padding-16-0-0-0"
                                                align="right"
                                                valign="middle"
                                                style="
                                              ...
                                              <td
                                                class="pc-w620-halign-right pc-w620-valign-middle pc-w620-padding-16-0-0-0"
                                                align="right"
                                                valign="middle"
                                                style="
                                                  padding: 16px 0px 4px 0px;
                                                        ...
                                                        <tr>
                                                          ...
                                                          >
                                                            ...
                                                            >
                                                              <tr>
                                                                <th
                                                                  class="pc-w620-spacing-0-0-4-0 pc-w620-align-right"
                                                                  align="right"
                                                                  valign="top"
                                                                  style="
                                                                    font-weight: normal;
                                    ...
                                    <tr>
                                      <td style="padding: 0px 0px 8px 0px">
                                        ...
                                        >
                                          ...
                                          >
                                            <td
                                              class="pc-grid-td-first pc-grid-td-last pc-w620-itemsSpacings-0-15"
                                              align="center"
                                              valign="middle"
                                              style="
                                                padding-top: 0px;
                                              ...
                                              >
                                                <div>
                                                  <span
                                                    ...
                                                    chúng tôi nếu bạn gặp bất kỳ
                                                    vấn đề nào với đơn hàng của
                                                    mình.</span
                                                  >
                                                </div>
                                              </div>
                                    ...
                                    <tr>
                                      <td>
                                        ...
                                        >
                                          ...
                                          >
                                            <td
                                              class="pc-grid-td-first pc-w620-itemsSpacings-0-12"
                                              align="left"
                                              valign="top"
                                              style="
                                                width: 50%;
                                                                                ...
                                                                                >
                                                                                  ...
                                                                                  >
                                                                                    <tr>
                                                                                      ...
                                                                                      >
                                                                                        <img
                                                                                          src="https://res.cloudinary.com/dyv5zfnit/image/upload/v1732099444/email/f15502045f28e419edb7be12fef9b14a_nxnayt.png"
                                                                                          width="50"
                                                                                          height="50"
                                                                                          alt=""
                                                                                          style="
                                            ...
                                            <td
                                              class="pc-grid-td-last pc-w620-itemsSpacings-0-12"
                                              align="left"
                                              valign="top"
                                              style="
                                                width: 50%;
                                                                                ...
                                                                                >
                                                                                  ...
                                                                                  >
                                                                                    <tr>
                                                                                      ...
                                                                                      >
                                                                                        <img
                                                                                          src="https://res.cloudinary.com/dyv5zfnit/image/upload/v1732099443/email/b6a976c3e3c27a9f1eff53cbc278ecab_hpntbo.png"
                                                                                          width="50"
                                                                                          height="50"
                                                                                          alt=""
                                                                                          style="
                                      ...
                                      <td>
                                        ...
                                        >
                                          <tr class="pc-grid-tr-first">
                                            <td
                                              class="pc-grid-td-first pc-grid-td-last pc-w620-itemsSpacings-0-28"
                                              align="center"
                                              valign="middle"
                                              style="
                                                width: 100%;
                                                                                ...
                                                                                >
                                                                                  ...
                                                                                  >
                                                                                    <tr>
                                                                                      ...
                                                                                      >
                                                                                        <img
                                                                                          src="https://res.cloudinary.com/dyv5zfnit/image/upload/v1732099443/email/97d1e3e2fd722d0140b51806fa857340_aicfsa.png"
                                                                                          class=""
                                                                                          width="24"
                                                                                          height="24"
                                                                                          style="
                                                                                ...
                                                                                >
                                                                                  ...
                                                                                  >
                                                                                    <tr>
                                                                                      ...
                                                                                      >
                                                                                        <img
                                                                                          src="https://res.cloudinary.com/dyv5zfnit/image/upload/v1732099444/email/fe68152620e8c8adcbb7728bd667dadb_fmcwzw.png"
                                                                                          class=""
                                                                                          width="24"
                                                                                          height="24"
                                                                                          style="
                                                                                ...
                                                                                >
                                                                                  ...
                                                                                  >
                                                                                    <tr>
                                                                                      ...
                                                                                      >
                                                                                        <img
                                                                                          src="https://res.cloudinary.com/dyv5zfnit/image/upload/v1732099443/email/1653acc9769ff508be2f3ac82aef2d63_ivwx3i.png"
                                                                                          class=""
                                                                                          width="24"
                                                                                          height="24"
                                                                                          style="
                                                            ...
                                                            <tr>
                                                              ...
                                                              >
                                                                ...
                                                                >
                                                                  ...
                                                                  >
                                                                    <td
                                                                      class="pc-grid-td-first pc-w620-itemsSpacings-4-30"
                                                                      valign="middle"
                                                                      style="
                                                                        padding-top: 0px;
                                                                        padding-right: 4px;
                                                                    ...
                                                                    <td
                                                                      class="pc-w620-itemsSpacings-4-30"
                                                                      valign="middle"
                                                                      style="
                                                                        padding-top: 0px;
                                                                        padding-right: 4px;
                                                                    ...
                                                                    <td
                                                                      class="pc-grid-td-last pc-w620-itemsSpacings-4-30"
                                                                      valign="middle"
                                                                      style="
                                                                        padding-top: 0px;
                                                                        padding-right: 0px;
